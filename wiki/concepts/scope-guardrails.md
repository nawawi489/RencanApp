...
> V1.8.2 memasukkan **KPI Area Target Breakdown** (§12.2: total kontribusi periode wajib 100%) **dan tetap menolak** "Bobot planning card". Keduanya beda konsep dan sengaja dipisah:
> - **Diizinkan** — *target-phasing satu kartu atas dirinya sendiri*: target tahunan KPI Area dipecah lintas Quarter/Bulan (baris breakdown ber-key `kpi_area_id + periode`). Bukan layer/hierarki baru.
...
> Implementasi Target Breakdown **wajib** sebagai baris pada KPI Area, **bukan** tabel kartu anak (kalau jadi tabel kartu anak = melanggar "KPI child table di bawah Area Goal").
