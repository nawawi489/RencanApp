...
- **Anti-scope-creep (PRD V1.82 §6):** tolak Feed, Company News, Announcement, SOP Center penuh, HRIS penuh, Payroll, Inventory, CRM, WhatsApp integration, AI Assistant, AI Review, Native app, **Social reaction feed / Story / Reels** (pola broadcast+popularitas), Watcher, Routine module, Checklist Routine, Area Goal, KPI cascade automation. **Jika AI agent mengusulkan fitur ini untuk V1.82, tolak.** — *Pengecualian sempit (owner 2026-07-13):* "Reaction pill tingkat-pesan" di Initiative Chat (PRD §30.6) diizinkan sepanjang zero bobot skor, tanpa feed/leaderboard, bukan approval, whitelist emoji ack tertutup, dan otorisasi = keanggotaan room. Detail: `wiki/concepts/scope-guardrails.md` §"Pengecualian sempit — Reaction pill Initiative Chat".
- **Integritas Bukti formal.** Bukti yang masuk riwayat versi, terkunci saat direview, dan dinilai Reviewer HANYA berasal dari jalur Bukti Task (PRD §24) — tidak dari chat, tidak dari lampiran informal, tidak dari sumber lain. Score Formula, Review, dan riwayat versi tidak boleh membaca artefak apa pun yang tidak diberi tag Bukti oleh sistem. — *Pengecualian sempit (owner 2026-07-15):* PRD §30 Rule 4 dipersempit — "lampiran diskusi (gambar)" di Initiative Chat (PRD §30 komponen 11) diizinkan sepanjang zero bobot skor, tidak masuk riwayat versi Bukti, tidak pernah menjadi input Review, dan batasnya ditegakkan struktural di database (bucket terpisah, tanpa FK ke evidence). Detail: `wiki/concepts/scope-guardrails.md` §"Pengecualian sempit — Lampiran diskusi Initiative Chat" dan `specs/inbox-chat-attachments.md`.
