...
/**
 * Orb capaian sistemik untuk header detail Goal/KPI/Initiative/Action Plan/Task.
 ...
 * tengah, label visual di bawah (`Capaian` untuk Goal/Strategy, `Progress` untuk lainnya).
...
/** UI-S-AP6 (KpiLinkageCard DA-AP6-1). "Masuk Strategy" + nama + sumber. */
...
export const IMPACT_APPROVAL_COPY = {
  ...
  body: (kpiName: string, proposed: number | string | null) =>
    proposed == null
      ? `Nilai Strategy "${kpiName}" akan diperbarui setelah Reviewer menyetujui submission ini.`
      : `Nilai Strategy "${kpiName}" akan diperbarui menjadi ${proposed} setelah Reviewer menyetujui submission ini.`,
};
