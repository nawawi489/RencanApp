...
const TEMPLATE_ITEMS: MenuItem[] = [
  ...
  { label: 'Strategy Template', description: 'Buat & edit', icon: 'bar-chart-outline', tone: 'warn', href: '/settings-kpi-area-templates' as Href, permission: 'manage_strategy_templates' },
];
...
const PENGATURAN_ITEMS: MenuItem[] = [
  ...
  { label: 'Repeat Setting', description: 'Jadwal Task', text: 'R', tone: 'success', href: '/settings-repeat-rules' as Href },
