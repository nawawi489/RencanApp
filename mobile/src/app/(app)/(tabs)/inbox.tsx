  ...
  return (
    <View className="gap-3 pb-3">
      <View className="gap-1">
        ...
        <Text className="text-base text-neutral-500 dark:text-neutral-400">Khusus chat ActionPlan.</Text>
      </View>
      <TextInput
        placeholder="Cari ActionPlan"
        placeholderTextColor={placeholderColor}
        value={q}
        onChangeText={setQ}
        accessibilityLabel="Cari ActionPlan"
...
export function LiveInboxScreen() {
  ...
  if (isLoading) {
    return (
      <Screen title="Inbox" subtitle="Khusus chat ActionPlan.">
  ...
  const emptyDescription = isSearching
    ? `Tidak ada ActionPlan cocok dengan "${trimmedQ}".`
    : isUnreadFilter
      ? 'Semua percakapan sudah dibaca.'
      : 'Setiap ActionPlan otomatis punya chat room. Akan muncul di sini.';
