...
export function LiveNewTaskScreen() {
  ...
  // UI-S-AP4 context-bar — tampilkan parent ActionPlan supaya PIC tahu "AP ini di bawah apa".
    ...
    <ScrollView className="flex-1 bg-neutral-50 dark:bg-black" keyboardShouldPersistTaps="handled">
      <View className="gap-4 p-5">
        {parentActionPlanQ.data ? (
          <View
            accessible
            accessibilityLabel={`Action Plan di bawah ActionPlan ${parentActionPlanQ.data.name}`}
