    ...
    <ScrollView className="flex-1 bg-neutral-50 dark:bg-black" keyboardShouldPersistTaps="handled">
      <View className="gap-4 p-5">
        <GuidanceNote
          ...
          body="Goal adalah sasaran tahunan tingkat tinggi. Periode otomatis mengikuti tahun Goal (1 Jan – 31 Des). Pecah jadi KPI Area, lalu Initiative dan ActionPlan. Card disimpan sebagai Draft dulu."
        />
