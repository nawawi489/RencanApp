  ...
  return (
    <PrototypeThemeBoundary>
      <View className="flex-1 gap-4 p-5">
        ...
        <Text className="text-base font-semibold text-[#172033]">{prototypeForms.actionPlanSubmit[0]}</Text>
        <Text className="text-base font-semibold text-[#172033]">{prototypeForms.actionPlanSubmit[1]}</Text>
      </View>
    </PrototypeThemeBoundary>
  );
}
