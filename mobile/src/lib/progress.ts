// UI-G-001 — derivasi capaian (0–100) untuk header detail Goal/KPI/Initiative/Action Plan/Task.
...
/** Task one-time: status-based heuristik (PRD eksekusi-loop). */
...
/**
 * Label bawah orb tree (spec §10 / WSA-15): Goal & Strategy = 'Capaian' (hasil KPI/Goal),
...
/**
 * Nilai orb Task leaf di tree. Reuse `computeTaskProgress` (satu sumber kebenaran).
