...
export const WS_COPY = {
  title: 'Workspace',
  subtitle: 'Performance — Goal, KPI Area, Initiative, ActionPlan & Action Plan.',
  ...
  emptyGoalDescCan: 'Buat Goal pertama lewat Wizard, lalu pecah jadi KPI Area, Initiative, dan ActionPlan.',
...
export const WS_HUB_COPY = {
  ...
  dev: {
    ...
    meta: 'Development Area → Problem Statement → ActionPlan → Action Plan',
    enter: 'Masuk',
...
export const WS_HELP_COPY = {
  ...
  development: {
    ...
    description:
      'Development Workspace berisi area perbaikan perusahaan, Problem Statement, ActionPlan, dan Action Plan.',
    checks: [
...
export const WS_DEV_COPY = {
  subtitle: 'Development — Development Area, Problem Statement, ActionPlan & Action Plan.',
  ...
  emptyDevAreaDescCan:
    'Buat Development Area pertama, lalu pecah jadi Problem Statement, ActionPlan, dan Action Plan.',
